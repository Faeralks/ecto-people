defmodule EctoPeopleWeb.PersonControllerTest do
  use EctoPeopleWeb.ConnCase

  import EctoPeople.AccountsFixtures

  @create_attrs %{age: 42, last_name: "some last_name", name: "some name", occupation: "some occupation"}
